...
const PaymentModal = (props) => {
  ...
  const [isTabIsoMessage, setIsTabIsoMessage] = useState(false);
  const [isTabMessageInput, setIsTabMessageInput] = useState(false);
  const [isTabMessageOutput, setIsTabMessageOutput] = useState(false);
  const [isTabMessagePayUpdate, setIsTabMessagePayUpdate] = useState(false);
  const [isTabMessagesRefund, setIsTabMessagesRefund] = useState(false);

...
const ContentTable = (props) => {
  ...
  const headerBTO1 = [
    ...
    { id: 'p', label: 'Tổ chức thành viên', minWidth: 50 },
    { id: 'bankReceiveCode', label: 'Bank Code', minWidth: 50 },
    { id: 'createtime', label: 'Thời gian tạo', minWidth: 50 },
    { id: 'modifytime', label: 'Thời gian chỉnh sửa', minWidth: 50 },
      ...
      listElements.forEach((object) => {
        ...
        var tableRow = (
          <TableRow key={rowIndex} className={object.id == props.rowSelected ? classes.rowSelected : rowIndex % 2 ? classes.evenRow : ''}>
            ...
            <TableCell className={classes.rowSelect}>{formatCurency(object.fee)}</TableCell>
            <TableCell className={classes.rowSelect}>{object.createdDatetime}</TableCell>
            <TableCell className={classes.rowSelect}>{object.modifDatetime}</TableCell>

...
const ContentTable = (props) => {
  ...
  const headerBTO1 = [
    ...
    { id: 'mmCode', label: 'Mã Merchant', minWidth: 50 },
    { id: 'fee', label: 'Phí áp dụng', minWidth: 50 },
    { id: 'status', label: 'Trạng thái', minWidth: 50 },
    { id: 'dateCreated', label: 'Ngày tạo', minWidth: 50 },
    { id: 'action', label: 'Hành động', minWidth: 50, width: '9rem'}
  ];
      ...
      listElements.forEach((object) => {
        ...
        var tableRow = (
          <TableRow key={rowIndex} className={object.id == props.rowSelected ? classes.rowSelected : rowIndex % 2 ? classes.evenRow : ''}>
            ...
            <TableCell className={classes.rowSelect}>{object.mmCode}</TableCell>
            <TableCell className={classes.rowSelect}>{object.fee}</TableCell>

...
const ModalContentDetail = (props) => {
  ...
  const keysToGetData = [
    { id: 'name', label: 'Tên Branch' },
    { id: 'branchCode', label: 'Branch Code' },
    { id: 'mcc', label: 'MCC' },
    // { id: 'qrName', label: 'Qr Name' },
    { id: 'settleBankName', label: 'Ngân hàng thanh toán' },
    { id: 'creditorAccount', label: 'Số tài khoản thành toán' },
    { id: 'paymentAcceptanceStatus', label: 'Trạng thái chấp Nhận Thanh Toán' }
  ];
            ...
            <>
              <Container maxWidth="sm">
                <Box component="fieldset" className={classes.nonBorder}>
                  <legend className={classes.tabTitle}>Chi tiết thông tin Branch</legend>
                  <Grid item xs={12}>

...
const ModalContentAction = (props) => {
  ...
  const formatShow = [
    ...
    { name: 'settleBankId', label: 'Ngân hàng', type: 'object', object: dataBankObject, required: true, show: true },
    { name: 'addressLine', label: 'Địa chỉ', type: 'text', object: null, required: true, show: true },
    { name: 'phoneNumber', label: 'Số điện thoại', type: 'text', object: null, required: true, show: true },
    { name: 'creditorAccount', label: 'Tài khoản người nhận', type: 'text', object: null, required: false, show: true },
    { name: 'ownerName', label: 'Tên chủ sở hữu', type: 'text', object: null, required: true, show: true },
    { name: 'emailAddress', label: 'Email', type: 'text', object: null, required: true, show: true }
  ];

...
const ContentTable = (props) => {
  ...
  const headerBTO1 = [
    ...
    { id: 'lastName', label: 'Họ', minWidth: 50 },
    { id: 'firstName', label: 'Tên đệm và tên', minWidth: 50 },
    { id: 'role', label: 'Vai trò', minWidth: 50 },
    { id: 'platform', label: 'Platform', minWidth: 50 },
    { id: 'phoneNunber', label: 'Số điện thoại', minWidth: 50 },
      ...
      listElements.forEach((object) => {
        ...
        var tableRow = (
          <TableRow key={rowIndex} className={object.id == props.rowSelected ? classes.rowSelected : rowIndex % 2 ? classes.evenRow : ''}>
            ...
            <TableCell className={classes.rowSelect}>{object.firstName}</TableCell>
            ...
            <TableCell className={classes.rowSelect}>{object.phoneNunber}</TableCell>
            <TableCell className={classes.rowSelect}>{object.email}</TableCell>
            <TableCell className={classes.rowSelect}>
              <>
  ...
  return (
    <>
      ...
      <ModalContentAction
        ...
        onLoad={props.onLoad}
        showError={showAlert}
        dataPlatform={props.dataPlatform}

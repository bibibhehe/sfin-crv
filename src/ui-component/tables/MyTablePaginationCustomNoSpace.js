...
const MyTablePaginationCustomNoSpace = (props) => {
  return (
...
const CustomTablePagination = styled(TablePagination)(
  ...
  & .${classes.toolbar}  {
    ...
    gap: 4px; /* Giảm khoảng cách giữa số dòng và phân trang */
    padding: 4px 0;
  ...
  & .${classes.actions} {
    display: flex;
    gap: 4px; /* Giảm khoảng cách giữa các nút phân trang */
    text-align: center;
  }
...
export default MyTablePaginationCustomNoSpace;
